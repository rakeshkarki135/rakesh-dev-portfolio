...
const Card = ({ skill }) => {
  return (
    <div className="w-80 px-6 py-9 sm:px-10 sm:py-13 flex flex-col gap-6 bg-surface-container-lowest rounded-xl border-on-secondary-fixed border shadow-inner shadow-primary-container hover:shadow-lg">
      {/* title */}
